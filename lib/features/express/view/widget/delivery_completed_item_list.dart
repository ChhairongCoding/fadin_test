...
class DeliveryCompletedItemList extends StatefulWidget {
  final String transportType;
  const DeliveryCompletedItemList({Key? key, required this.transportType})
      : super(key: key);

  @override
  State<DeliveryCompletedItemList> createState() =>
      _DeliveryCompletedItemListState();
}

class _DeliveryCompletedItemListState extends State<DeliveryCompletedItemList> {
  ExpressController _expressController =
      Get.put(ExpressController(), tag: "completed");
  ...
  void initState() {
    ...
    _expressController.initDeliveryList("completed", widget.transportType);
    _expressController.paginateDeliveryList("completed", widget.transportType);
    super.initState();
  }
