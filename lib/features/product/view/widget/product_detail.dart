...
class _ProductDetailPageWrapperState extends State<ProductDetailPageWrapper> {
  ...
  void initState() {
    ...
    super.initState();
    Get.find<ProductController>().getProductDetail(
        productId: widget.id,
  ...
  Widget build(BuildContext context) {
    return Scaffold(body: GetBuilder<ProductController>(
      ...
      if (controller.productDetail.toString() == "null" ||
                                ...
                                widget.description.toString() != "null" ||
                                    ...
                                    : Container(
                                        padding: EdgeInsets.symmetric(
                                            horizontal: 10),
                                        child: HtmlWidget(
                                          widget.description.contains('"//img')
                                              ? """${widget.description.replaceAll("//img", "http://img")}"""
                                              : widget.description,
