...
class DeliveryPickupItemList extends StatefulWidget {
  final String transportType;
  const DeliveryPickupItemList({Key? key, required this.transportType})
      : super(key: key);

  @override
  State<DeliveryPickupItemList> createState() => _DeliveryPickupItemListState();
}

class _DeliveryPickupItemListState extends State<DeliveryPickupItemList> {
  ExpressController _expressController =
      Get.put(ExpressController(), tag: "pickup");
  ...
  void initState() {
    ...
    _expressController.initDeliveryList("pickup", widget.transportType);
    _expressController.paginateDeliveryList("pickup", widget.transportType);
    super.initState();
  }
